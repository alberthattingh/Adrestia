    ...
    public partial class StudentLessons : UserControl
    {
        ...
        private void BtnBook_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        credits = reader.GetValue(1).ToString();
                    }
                    conn.Close();
                }
        ...
        private void BtnCancelBooking_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                doubleCredits = double.Parse(credits);
                ...
                sqlQuery = "UPDATE LESSON SET AvailablePlaces  = " + intspaces + 1 + " WHERE LessonID = '" + selectedLesson + "'";
        ...
        private void DgvStudentLessons_SelectionChanged_1(object sender, EventArgs e)
        {
            ...
            if (dgvStudentLessons.SelectedCells.Count > 0)
            {
                ...
                selectedMax = Convert.ToString(selectedRow.Cells["AvailablePlaces"].Value);
