...
namespace Adrestia
{
    ...
    {
        public static string ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Adrestia\Adrestia\Adrestia\Database5.mdf;Integrated Security=True;MultipleActiveResultSets=true";
